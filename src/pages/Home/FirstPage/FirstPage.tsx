...
const FirstPage = () => {
    ...
    useEffect(() => {
        if (!Trip) dispatch(homeActions.setTab(1));
    }, [Trip, dispatch]);


    if (!data) return <>   {ToasterService.showError(`Please Select Any Trip Card`)}</>
    if (!Trip) return <>   {ToasterService.showError(`Please Select Any Trip Card`)}</>
                ...
                <div className="upper">
                    ...
                    <div className="right">
                        <iframe
                            className="frame"
                            title="myFrame"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3416.8083639023066!2d74.4158532154682!3d31.087257175509794!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3919b9e4c0b469e5%3A0xe8e1bd8667a7f333!2sShakir%20madical%20store!5e0!3m2!1sen!2sin!4v1644147325324!5m2!1sen!2sin"
                            width="100%"
